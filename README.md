...
We also used detention facility data that the [National Immigrant Justice Center](https://www.immigrantjustice.org/issues/transparencyandhumanrights) got in response to a FOIA request to ICE. We included here a subset of that data with the names, addresses, areas of responsibility (AOR), years of operation (DD/MM/YYYY) and longitudes and latitudes for all immigrant detention facilities, from calendar year 1978 through November of calendar year 2017.
